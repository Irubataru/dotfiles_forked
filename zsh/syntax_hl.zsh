...
# interface file in GHC - https://github.com/trapd00r/LS_COLORS/pull/9'
  ...
  filetype-o                    'fg=240'
  filetype-pacnew               'fg=33'
  filetype-patch                'bg=197,fg=232;1'
  filetype-pc                   'fg=100'
  filetype-pfa                  'fg=43'
  filetype-php                  'fg=93'
  filetype-pid                  'fg=160'
...
# Emulator roms, emulator savegames                                          {{{'
  ...
  filetype-nds                  'fg=193'
  filetype-nes                  'fg=160'
  filetype-rom                  'fg=59;1'
  filetype-sav                  'fg=220'
  filetype-sms                  'fg=33'
  filetype-st                   'fg=208;1'
#}}}'
# images                                                                     {{{'
  filetype-iso                  'fg=124'
  filetype-nrg                  'fg=124'
...
# video                                                                      {{{'
  ...
  filetype-ogv                  'fg=94'
  filetype-rmvb                 'fg=112'
  filetype-sample               'fg=130;1'
  filetype-ts                   'fg=39'
  filetype-vob                  'fg=137'
  filetype-webm                 'fg=109'
  filetype-wmv                  'fg=113'
#}}}'
# music, audio                                                               {{{'
  filetype-S3M                  'fg=71;1'
  filetype-aac                  'fg=137'
  filetype-cue                  'fg=112'
  filetype-dat                  'fg=165'
  filetype-dts                  'fg=100;1'
  filetype-fcm                  'fg=41'
  filetype-flac                 'fg=166;1'
  filetype-m3u                  'fg=172'
  filetype-m4                   'fg=196;3'
...
# (compressed) archives                                                      {{{'
  ...
  filetype-r09                  'fg=239'
  filetype-r10                  'fg=239'
  filetype-r100                 'fg=239'
  filetype-r101                 'fg=239'
  filetype-r102                 'fg=239'
  filetype-r103                 'fg=239'
  filetype-r104                 'fg=239'
  filetype-r105                 'fg=239'
  filetype-r106                 'fg=239'
  filetype-r107                 'fg=239'
  filetype-r108                 'fg=239'
  filetype-r109                 'fg=239'
  filetype-r11                  'fg=239'
  filetype-r110                 'fg=239'
  filetype-r111                 'fg=239'
  filetype-r112                 'fg=239'
  filetype-r113                 'fg=239'
  filetype-r114                 'fg=239'
  filetype-r115                 'fg=239'
  filetype-r116                 'fg=239'
  filetype-r12                  'fg=239'
  filetype-r13                  'fg=239'
  filetype-r14                  'fg=239'
  filetype-r15                  'fg=239'
...
# /etc/hosts.{deny,allow}                                                    {{{'
  filetype-allow                'fg=112'
  filetype-deny                 'fg=196'
